...
# --- (F) Clear user histories and caches
for dir in /home/*; do
  [[ -d "$dir" ]] || continue
...
# --- (M) Make space for Imager’s first-boot metadata (optional hygiene)
